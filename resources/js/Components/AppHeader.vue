...
<template>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand fw-bold" href="javascript:void(0)" @click="onBtnClicked('ccpc.index')">CCPC</a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="javascript:void(0)" @click="onBtnClicked('ccpc.index')">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="javascript:void(0)" @click="onBtnClicked('ccpc.competitionInfo')">競賽資訊</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="javascript:void(0)" @click="onBtnClicked('ccpc.transportationInfo')">交通資訊</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item" v-if="!page.props.auth.user">
                        <a class="nav-link" aria-current="page" href="javascript:void(0)" @click="onBtnClicked('ccpc.login')">Login</a>
                    </li>
                    <template v-else>
                        <li class="nav-item">

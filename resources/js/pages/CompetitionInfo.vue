<template>
    ...
    <hr>
    <h3>活動日期</h3>
    <p style="color:red">2025 年 5 月 24 日（六）</p>
    ...
    <ol class="rule-list">
        <li>參賽以個人為主</li>
        <li>比賽當日請選手攜帶學生證進場，以利身份確認。</li>
        <li>比賽方式以上機撰寫程式為主
            <ul class="unstyled" style="color:red;padding-left:20px;">
                <li>比賽使用語言：C/C++、JAVA、Python</li>
                <li>編譯器版本：GCC4.6.1 以上、JDK1.6 以上、Python 3.6 以上</li>
                <li>比賽提供IDE：Dev C++, Eclipse, VS Code</li>
